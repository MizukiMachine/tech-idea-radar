...
## 各アイデアのJSON形式
{
  ...
  "developmentScale": 1〜5の整数（1=軽い検証、2=小さめ、3=中規模、4=大きめ、5=かなり大きい構想）,
  "developmentScaleReason": "開発規模をその星数にした理由",
...
- developmentScaleは「現代のLLMを使える開発者が作る前提」で、実装量、外部連携、データ整備、運用設計、検証の難しさから判断すること
- developmentScaleが5でも除外しないこと。大きい構想の場合は、段階的に検証できる仮説として書くこと
...
上記のトレンドデータをもとに、技術者やプロダクト開発者が検証を始められる魅力的なプロダクト仮説を最大 {requested_idea_count} 件提案してください。
