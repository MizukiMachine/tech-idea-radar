...
- **Outstanding Items**:
  ...
  - Export a GitHub PAT as `GITHUB_TOKEN` before running MCP commands so the configured MCP manifests (`~/.config/codex-cli/mcp.json`, `~/.config/codex/codex-mcp.json`) can authenticate.
