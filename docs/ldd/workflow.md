...
- When the planning tool supplies a plan, echo the mapping to the prompt chain before editing code.
- Cursor reviews depend on concise change descriptions; ensure `handoff_summary` references file paths and line numbers.
- Lint findings should be captured with TODO tags until resolved.
